...
@XmlRootElement(name = "money-control-bse-active-100_history")
@Entity
@Data
@Table(name = "moneycontrol_bse_active_100_history")
public class MoneyControlBSEActive100HistoryEntity extends AbstractEntity {
    ...
    public MoneyControlBSEActive100HistoryEntity() {
        super();
