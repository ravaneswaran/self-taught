...
@XmlRootElement(name = "money-control-bse-active-200-history")
@Entity
@Data
@Table(name = "moneycontrol_bse_active_200_history")
public class MoneyControlBSEActive200HistoryEntity extends AbstractEntity {
    ...
    public MoneyControlBSEActive200HistoryEntity() {
        super();
