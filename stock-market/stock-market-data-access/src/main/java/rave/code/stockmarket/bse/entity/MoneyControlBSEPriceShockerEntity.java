...
@XmlRootElement(name = "money-control-price-shocker")
@Entity
@Data
@Table(name = "moneycontrol_bse_price_shockers")
public class MoneyControlBSEPriceShockerEntity extends AbstractEntity {
    ...
    public MoneyControlBSEPriceShockerEntity() {
        super();
