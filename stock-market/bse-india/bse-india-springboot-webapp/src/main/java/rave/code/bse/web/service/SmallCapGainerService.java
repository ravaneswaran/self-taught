...
import rave.code.bse.web.model.stock.SmallCapGainerStock;
...
public class SmallCapGainerService extends AbstractService<MoneyControlBSESmallCapGainerEntity, SmallCapGainerStock> {
    ...
    @Override
    public List<SmallCapGainerStock> getStocks(List<MoneyControlBSESmallCapGainerEntity> entities) {

        List<SmallCapGainerStock> stocks = new ArrayList<>();
        for (MoneyControlBSESmallCapGainerEntity entity : entities) {
            SmallCapGainerStock stock = new SmallCapGainerStock();
