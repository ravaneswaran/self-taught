...
@XmlRootElement(name = "money-control-bse-active-500")
@Entity
@Data
@Table(name = "moneycontrol_bse_active_500")
public class MoneyControlBSEActive500Entity extends AbstractEntity {
    ...
    public MoneyControlBSEActive500Entity() {
        super();
