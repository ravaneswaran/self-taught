...
@XmlRootElement(name = "money-control-bse-active-500-history")
@Entity
@Data
@Table(name = "moneycontrol_bse_active_500_history")
public class MoneyControlBSEActive500HistoryEntity extends AbstractEntity {
    ...
    public MoneyControlBSEActive500HistoryEntity() {
        super();
