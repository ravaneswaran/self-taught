...
@XmlRootElement(name = "moneycontrol_bse_mid_cap_gainer")
@Entity
@Data
@Table(name = "moneycontrol_bse_mid_cap_gainer")
public class MoneyControlBSEMidCapGainerEntity extends AbstractEntity {
    ...
    public MoneyControlBSEMidCapGainerEntity(){
        super();
    }
