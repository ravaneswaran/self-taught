...
public class TestBSEVolumeShockerDataAccess extends TestCase {
    ...
    public void testSaveMethod() {
        ...
        BSEVolumeShockerEntity returnElement = bseVolumeShockerDataAccess.findBy(bseVolumeShockerEntity.getStockName());
