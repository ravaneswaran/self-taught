...
public class TestBSEActive100DataAccess extends TestCase {
    ...
    public void testSaveMethod() {
        ...
        bseActive100Entity.setCompanyName("test-company" + new Date().getTime());
        ...
        System.out.println("------------------------>>>>>>> " + bseActive100Entity.getCompanyName());
        ...
        BSEActive100Entity returnElement = moneyControlBSEActive100DataAccess.findBy(bseActive100Entity.getCompanyName());
