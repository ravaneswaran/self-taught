...
public class BSEOnlyBuyersParser extends BSEActiveParser {

    private static final Logger LOGGER = Logger.getLogger(BSEOnlyBuyersParser.class.getName());

    public BSEOnlyBuyersParser() {
        super("https://www.moneycontrol.com/stocks/marketstats/onlybuyers.php?optex=BSE&opttopic=buyers&sort=perchg");
    }

    @Override
    public List<BSEGenericActiveModel> parse() {
        LOGGER.log(Level.INFO, String.format("BSEOnlyBuyersParser : Looking for BSE only buyers stocks at(%s)...", this.getSourceUrl()));
            ...
            if (document != null) {
                ...
                for (Element tr : tableRows) {
                    ...
                    /*if (tableData.size() >= 24) {
                        ...
                        bseGenericActiveModel.setVolumeWeightedAveragePrice(volumeWeightedAveragePrice);
    ...
    public static void main(String[] args) {
        BSEOnlyBuyersParser bseOnlyBuyersParser = new BSEOnlyBuyersParser();
        bseOnlyBuyersParser.parse();
    }
}
