package rave.code.jpa.postgres.controller;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.http.ResponseEntity;
import org.springframework.web.bind.annotation.*;
import rave.code.jpa.postgres.entity.Person;
import rave.code.jpa.postgres.request.PersonRequest;
import rave.code.jpa.postgres.service.PersonService;
...
public class PersonController {
    ...
    public ResponseEntity<Iterable<Person>> getAllPersons() {
        return ResponseEntity.status(200).body(this.personService.getAllPersons());
    }
