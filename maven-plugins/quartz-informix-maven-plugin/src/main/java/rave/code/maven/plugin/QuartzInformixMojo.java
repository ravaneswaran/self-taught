...
public abstract class QuartzInformixMojo extends AbstractMojo {
    ...
    @Parameter(property = "prefix", required = false, defaultValue = "q")
        ...
        try (InputStream inputStream = this.getClass().getResourceAsStream("/" + fileName);
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (line.endsWith(";")) {
                    ...
                    sql = sql.substring(0, sql.length() - 1).replaceAll("q_", this.prefix);; // remove last semicolon
