...
import rave.code.utility.parser.html.moneycontrol.model.MoneyControlGainerModel;
...
public class MoneyControlNSETopGainersParser extends HTMLSourceParser {

    public MoneyControlNSETopGainersParser() {
        super("https://www.moneycontrol.com/stocks/marketstats/nsegainer/index.php");
    }
    ...
    public static void main(String[] args) {
        MoneyControlNSETopGainersParser moneyControlNSETopGainersParser = new MoneyControlNSETopGainersParser();
        moneyControlNSETopGainersParser.parse();
    }
}
