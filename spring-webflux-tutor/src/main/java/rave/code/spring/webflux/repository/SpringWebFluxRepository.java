...
public abstract class SpringWebFluxRepository<T> {

    private static final String PERSISTENCE_UNIT_NAME = "spring_webflux";
    ...
    public SpringWebFluxRepository(Class<T> type) {
        this.type = type;
